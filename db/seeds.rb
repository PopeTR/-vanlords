...
user1 = User.create(name: 'Sandra Verhof', password: 'password', phone_number: '06 9461 7162', email: "sandra.verhof@gmail.com")
...
user1 = User.create(name: 'Sacha Meyer', password: 'password', phone_number: '07 8472 7162', email: "sacha.meyer@gmail.com")
user1.photo.attach(io: file, filename: 'user2.png', content_type: 'image/png')
